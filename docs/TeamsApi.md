...
<a name="createteam"></a>
# **CreateTeam**
> CreateTeamResponse CreateTeam (NewTeamPayload newTeamPayload = null)
...
namespace Example
{
    public class CreateTeamExample
    {
        public static void Main()
        {
            ...
            var newTeamPayload = new NewTeamPayload(); // NewTeamPayload |  (optional) 
...
<a name="listteams"></a>
# **ListTeams**
> Object ListTeams (int? perPage = null, string cursor = null)
...
<a name="updateteam"></a>
# **UpdateTeam**
> UpdateTeamResponse UpdateTeam (string team, UpdateTeamPayload updateTeamPayload = null)
...
namespace Example
{
    public class UpdateTeamExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new TeamsApi(config);
            var team = team_example;  // string | 
            var updateTeamPayload = new UpdateTeamPayload(); // UpdateTeamPayload |  (optional) 

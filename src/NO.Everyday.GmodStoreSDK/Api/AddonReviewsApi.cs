...
namespace NO.Everyday.GmodStoreSDK.Api
{
        ...
        public partial class AddonReviewsApi : IAddonReviewsApi
    {
        ...
        public ApiResponse< InlineResponse2005 > AddonsAddonIdReviewsReviewIdGetWithHttpInfo (long? addonId, long? reviewId, List<string> with = null)
        {
            // verify the required parameter 'addonId' is set
            if (addonId == null)
                throw new ApiException(400, "Missing required parameter 'addonId' when calling AddonReviewsApi->AddonsAddonIdReviewsReviewIdGet");
            // verify the required parameter 'reviewId' is set
            if (reviewId == null)
                throw new ApiException(400, "Missing required parameter 'reviewId' when calling AddonReviewsApi->AddonsAddonIdReviewsReviewIdGet");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AddonsAddonIdReviewsReviewIdGet", localVarResponse);
                if (exception != null) throw exception;
            }

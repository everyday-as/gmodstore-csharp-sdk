...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    public partial class UserFilter : IEquatable<UserFilter>, IValidatableObject
    {
        ...
        public UserFilter(long steamId = default(long))
        {
        ...
        {
            return this.Equals(input as UserFilter);
        }

        /// <summary>
        /// Returns true if UserFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of UserFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserFilter input)
        {
            if (input == null)
                return false;

...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    /// TeamAddon
    /// </summary>
    [DataContract(Name = "TeamAddon")]
    public partial class TeamAddon : IEquatable<TeamAddon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamAddon" /> class.
        /// </summary>
        ...
        public TeamAddon(long id = default(long), bool active = default(bool), string name = default(string), string shortDescription = default(string), string description = default(string), List<string> requirements = default(List<string>), AddonPrice price = default(AddonPrice), AddonImages images = default(AddonImages), AddonVersion latestVersion = default(AddonVersion), Team team = default(Team), AddonStats stats = default(AddonStats))
        {
            this.Id = id;
            this.Active = active;
            this.Name = name;
        ...
        {
            return this.Equals(input as TeamAddon);
        }

        /// <summary>
        /// Returns true if TeamAddon instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamAddon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamAddon input)
        {
            if (input == null)
                return false;

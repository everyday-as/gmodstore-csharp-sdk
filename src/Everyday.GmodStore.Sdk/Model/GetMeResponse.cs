...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    public partial class GetMeResponse : IEquatable<GetMeResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GetMeResponse);
        }

        /// <summary>
        /// Returns true if GetMeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetMeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMeResponse input)
        {
            if (input == null)
                return false;

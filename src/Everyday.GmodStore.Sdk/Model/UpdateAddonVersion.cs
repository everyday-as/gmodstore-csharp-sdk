...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateAddonVersion :  IEquatable<UpdateAddonVersion>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAddonVersion" /> class.
        /// </summary>
        ...
        public UpdateAddonVersion(string name = default(string), string changelog = default(string), ReleaseTypeEnum? releaseType = default(ReleaseTypeEnum?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateAddonVersion);
        }

        /// <summary>
        /// Returns true if UpdateAddonVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAddonVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAddonVersion input)
        {
            if (input == null)
                return false;

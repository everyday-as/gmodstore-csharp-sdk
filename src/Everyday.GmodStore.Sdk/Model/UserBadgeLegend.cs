...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    /// UserBadgeLegend
    /// </summary>
    [DataContract(Name = "UserBadgeLegend")]
    public partial class UserBadgeLegend : IEquatable<UserBadgeLegend>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UserBadgeLegend);
        }

        /// <summary>
        /// Returns true if UserBadgeLegend instances are equal
        /// </summary>
        /// <param name="input">Instance of UserBadgeLegend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserBadgeLegend input)
        {
            if (input == null)
                return false;

...
namespace Everyday.GmodStore.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductVersionFilter")]
    public partial class ProductVersionFilter : IEquatable<ProductVersionFilter>, IValidatableObject
    {
        /// <summary>
        /// Defines ReleaseType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVersionFilter" /> class.
        /// </summary>
        /// <param name="releaseType">releaseType.</param>
        public ProductVersionFilter(ReleaseTypeEnum? releaseType = default(ReleaseTypeEnum?))
        {
        ...
        {
            return this.Equals(input as ProductVersionFilter);
        }

        /// <summary>
        /// Returns true if ProductVersionFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVersionFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVersionFilter input)
        {
            if (input == null)
                return false;

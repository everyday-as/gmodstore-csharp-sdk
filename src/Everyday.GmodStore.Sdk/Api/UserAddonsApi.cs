...
namespace Everyday.GmodStore.Sdk.Api
{
    ...
    public interface IUserAddonsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AddonListResponse> ListUserAddonsAsync (long userId, List<string> with = default(List<string>));
        ...
        System.Threading.Tasks.Task<ApiResponse<AddonListResponse>> ListUserAddonsAsyncWithHttpInfo (long userId, List<string> with = default(List<string>));
    ...
    public partial class UserAddonsApi : IUserAddonsApi
    {
        ...
        /// <param name="with">The relations you want to fetch with the &#x60;Addon&#x60; (optional)</param>
        /// <returns>Task of AddonListResponse</returns>
        public async System.Threading.Tasks.Task<AddonListResponse> ListUserAddonsAsync (long userId, List<string> with = default(List<string>))
        {
             Everyday.GmodStore.Sdk.Client.ApiResponse<AddonListResponse> localVarResponse = await ListUserAddonsAsyncWithHttpInfo(userId, with);
             return localVarResponse.Data;
        ...
        /// <param name="with">The relations you want to fetch with the &#x60;Addon&#x60; (optional)</param>
        /// <returns>Task of ApiResponse (AddonListResponse)</returns>
        public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<AddonListResponse>> ListUserAddonsAsyncWithHttpInfo (long userId, List<string> with = default(List<string>))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<AddonListResponse>("/users/{user_id}/addons", localVarRequestOptions, this.Configuration);

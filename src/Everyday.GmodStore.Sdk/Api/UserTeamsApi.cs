...
System.Threading.Tasks.Task<TeamListResponse> ListUserTeamsAsync (long userId, List<string> with = default(List<string>));
...
System.Threading.Tasks.Task<ApiResponse<TeamListResponse> > ListUserTeamsAsyncWithHttpInfo (long userId, List<string> with = default(List<string>));
...
/// <param name="with">The relations you want to fetch with the &#x60;Team&#x60; (optional)</param>
/// <returns>Task of TeamListResponse</returns>
public async System.Threading.Tasks.Task<TeamListResponse> ListUserTeamsAsync (long userId, List<string> with = default(List<string>))
{
	Everyday.GmodStore.Sdk.Client.ApiResponse<TeamListResponse> localVarResponse = await ListUserTeamsAsyncWithHttpInfo(userId, with);
	return localVarResponse.Data;
...
/// <param name="with">The relations you want to fetch with the &#x60;Team&#x60; (optional)</param>
/// <returns>Task of ApiResponse (TeamListResponse)</returns>
public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<TeamListResponse> > ListUserTeamsAsyncWithHttpInfo (long userId, List<string> with = default(List<string>))
{
	...
	var localVarResponse = await this.AsynchronousClient.GetAsync<TeamListResponse>("/users/{user_id}/teams", localVarRequestOptions, this.Configuration);

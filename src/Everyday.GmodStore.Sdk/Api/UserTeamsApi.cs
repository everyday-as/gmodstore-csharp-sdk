...
namespace Everyday.GmodStore.Sdk.Api
{
    ...
    public interface IUserTeamsApiSync : IApiAccessor
    {
        ...
        Object ListUserTeams(string user, int? perPage = default(int?), string cursor = default(string));
        ...
        ApiResponse<Object> ListUserTeamsWithHttpInfo(string user, int? perPage = default(int?), string cursor = default(string));
    ...
    public interface IUserTeamsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> ListUserTeamsAsync(string user, int? perPage = default(int?), string cursor = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ListUserTeamsWithHttpInfoAsync(string user, int? perPage = default(int?), string cursor = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class UserTeamsApi : IUserTeamsApi
    {
        ...
        /// <param name="cursor">The cursor from which to return paginated results starting after (optional)</param>
        /// <returns>Object</returns>
        public Object ListUserTeams(string user, int? perPage = default(int?), string cursor = default(string))
        {
            Everyday.GmodStore.Sdk.Client.ApiResponse<Object> localVarResponse = ListUserTeamsWithHttpInfo(user, perPage, cursor);
        ...
        /// <param name="cursor">The cursor from which to return paginated results starting after (optional)</param>
        /// <returns>ApiResponse of Object</returns>
        public Everyday.GmodStore.Sdk.Client.ApiResponse<Object> ListUserTeamsWithHttpInfo(string user, int? perPage = default(int?), string cursor = default(string))
        {
            // verify the required parameter 'user' is set
            if (user == null)
                throw new Everyday.GmodStore.Sdk.Client.ApiException(400, "Missing required parameter 'user' when calling UserTeamsApi->ListUserTeams");
            ...
            var localVarResponse = this.Client.Get<Object>("/api/v3/users/{user}/teams", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> ListUserTeamsAsync(string user, int? perPage = default(int?), string cursor = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Everyday.GmodStore.Sdk.Client.ApiResponse<Object> localVarResponse = await ListUserTeamsWithHttpInfoAsync(user, perPage, cursor, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<Object>> ListUserTeamsWithHttpInfoAsync(string user, int? perPage = default(int?), string cursor = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'user' is set
            if (user == null)
                throw new Everyday.GmodStore.Sdk.Client.ApiException(400, "Missing required parameter 'user' when calling UserTeamsApi->ListUserTeams");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/v3/users/{user}/teams", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

...
namespace Everyday.GmodStore.Sdk.Api
{
    ...
    public interface ITeamAddonsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TeamUserListResponse> ListTeamAddonsAsync (long teamId);
        ...
        System.Threading.Tasks.Task<ApiResponse<TeamUserListResponse>> ListTeamAddonsAsyncWithHttpInfo (long teamId);
    ...
    public partial class TeamAddonsApi : ITeamAddonsApi
    {
        ...
        /// <param name="teamId">Id of the team</param>
        /// <returns>Task of TeamUserListResponse</returns>
        public async System.Threading.Tasks.Task<TeamUserListResponse> ListTeamAddonsAsync (long teamId)
        {
             Everyday.GmodStore.Sdk.Client.ApiResponse<TeamUserListResponse> localVarResponse = await ListTeamAddonsAsyncWithHttpInfo(teamId);
             return localVarResponse.Data;
        ...
        /// <param name="teamId">Id of the team</param>
        /// <returns>Task of ApiResponse (TeamUserListResponse)</returns>
        public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<TeamUserListResponse>> ListTeamAddonsAsyncWithHttpInfo (long teamId)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TeamUserListResponse>("/teams/{team_id}/addons", localVarRequestOptions, this.Configuration);

...
namespace Everyday.GmodStore.Sdk.Api
{
    ...
    public interface ITeamsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TeamResponse> GetTeamAsync(long teamId, List<string> with = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TeamResponse>> GetTeamWithHttpInfoAsync(long teamId, List<string> with = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TeamsApi : ITeamsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TeamResponse</returns>
        public async System.Threading.Tasks.Task<TeamResponse> GetTeamAsync(long teamId, List<string> with = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Everyday.GmodStore.Sdk.Client.ApiResponse<TeamResponse> localVarResponse = await GetTeamWithHttpInfoAsync(teamId, with, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TeamResponse)</returns>
        public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<TeamResponse>> GetTeamWithHttpInfoAsync(long teamId, List<string> with = default(List<string>), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TeamResponse>("/teams/{team_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);

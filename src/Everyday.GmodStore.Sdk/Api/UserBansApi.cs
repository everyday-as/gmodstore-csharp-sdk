...
namespace Everyday.GmodStore.Sdk.Api
{
    ...
    public partial class UserBansApi : IUserBansApi
    {
        ...
        {
             Everyday.GmodStore.Sdk.Client.ApiResponse<UserBanListResponse> localVarResponse = await ListUserBansAsyncWithHttpInfo(userId);
             return localVarResponse.Data;
        ...
        /// <param name="userId">Id of the user</param>
        /// <returns>Task of ApiResponse (UserBanListResponse)</returns>
        public async System.Threading.Tasks.Task<Everyday.GmodStore.Sdk.Client.ApiResponse<UserBanListResponse>> ListUserBansAsyncWithHttpInfo (long userId)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserBanListResponse>("/users/{user_id}/bans", localVarRequestOptions, this.Configuration);

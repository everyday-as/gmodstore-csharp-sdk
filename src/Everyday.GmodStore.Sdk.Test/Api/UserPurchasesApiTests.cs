...
namespace Everyday.GmodStore.Sdk.Test.Api
{
    ...
    /// </remarks>
    public class UserPurchasesApiTests : IDisposable
    {
        private UserPurchasesApi instance;

        public UserPurchasesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' UserPurchasesApi
            //Assert.IsType<UserPurchasesApi>(instance);
        }

...
namespace Everyday.GmodStore.Sdk.Test.Api
{
    ...
    /// </remarks>
    public class AddonReviewsApiTests : IDisposable
    {
        private AddonReviewsApi instance;

        public AddonReviewsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' AddonReviewsApi
            //Assert.IsType<AddonReviewsApi>(instance);
        }
        ...
        public void GetAddonReviewTest()
        {
            ...
            //Assert.IsType<AddonReviewResponse>(response);
        }
        ...
        public void ListAddonReviewsTest()
        {
            ...
            //Assert.IsType<AddonReviewListResponse>(response);
        }
    }
}

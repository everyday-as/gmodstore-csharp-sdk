...
namespace Everyday.GmodStore.Sdk.Test
{
    ...
    public class AdventCalendarApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' AdventCalendarApi
            //Assert.IsType(typeof(AdventCalendarApi), instance, "instance is a AdventCalendarApi");
        }
        ...
        public void GetAdventCalendarStatsTest()
        {
            ...
            //Assert.IsType<AdventCalendarStatsResponse> (response, "response is AdventCalendarStatsResponse");
        }
